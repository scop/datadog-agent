...
func (m *Model) GetEvaluator(field eval.Field, regID eval.RegisterID) (eval.Evaluator, error) {
	...
	case "chmod.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {

				return (*Event)(ctx.Object).ResolveFileInUpperLayer(&(*Event)(ctx.Object).Chmod.FileEvent)
	...
	case "chown.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {

				return (*Event)(ctx.Object).ResolveFileInUpperLayer(&(*Event)(ctx.Object).Chown.FileEvent)
	...
	case "link.source.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {
	...
	case "link.target.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {
	...
	case "mkdir.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {

				return (*Event)(ctx.Object).ResolveFileInUpperLayer(&(*Event)(ctx.Object).Mkdir.FileEvent)
	...
	case "open.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {

				return (*Event)(ctx.Object).ResolveFileInUpperLayer(&(*Event)(ctx.Object).Open.FileEvent)
	...
	case "removexattr.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {

				return (*Event)(ctx.Object).ResolveFileInUpperLayer(&(*Event)(ctx.Object).RemoveXAttr.FileEvent)
	...
	case "rename.new.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {
	...
	case "rename.old.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {
	...
	case "rmdir.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {

				return (*Event)(ctx.Object).ResolveFileInUpperLayer(&(*Event)(ctx.Object).Rmdir.FileEvent)
	...
	case "setxattr.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {

				return (*Event)(ctx.Object).ResolveFileInUpperLayer(&(*Event)(ctx.Object).SetXAttr.FileEvent)
	...
	case "unlink.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {

				return (*Event)(ctx.Object).ResolveFileInUpperLayer(&(*Event)(ctx.Object).Unlink.FileEvent)
	...
	case "utimes.in_upper_layer":
		return &eval.BoolEvaluator{
			EvalFnc: func(ctx *eval.Context) bool {

				return (*Event)(ctx.Object).ResolveFileInUpperLayer(&(*Event)(ctx.Object).Utimes.FileEvent)
...
func (e *Event) GetFields() []eval.Field {
	return []eval.Field{
		...
		"rename.new.filename",
		"rename.new.in_upper_layer",
		"rename.new.inode",
		"rename.old.basename",
		"rename.old.container_path",
		"rename.old.filename",
		"rename.old.in_upper_layer",
		"rename.old.inode",
		"rename.retval",
		"rmdir.basename",
		"rmdir.container_path",
		"rmdir.filename",
		"rmdir.in_upper_layer",
		"rmdir.inode",
		"rmdir.retval",
		"setxattr.basename",
		"setxattr.container_path",
		"setxattr.filename",
		"setxattr.in_upper_layer",
		"setxattr.inode",
		"setxattr.name",
		"setxattr.namespace",
		"setxattr.retval",
		...
		"unlink.filename",
		"unlink.flags",
		"unlink.in_upper_layer",
		"unlink.inode",
		"unlink.retval",
		"utimes.basename",
		"utimes.container_path",
		"utimes.filename",
		"utimes.in_upper_layer",
		"utimes.inode",
		"utimes.retval",
	}
}
...
func (e *Event) GetFieldValue(field eval.Field) (interface{}, error) {
	...
	case "chmod.in_upper_layer":
		...
		return e.ResolveFileInUpperLayer(&e.Chmod.FileEvent), nil
	...
	case "chown.in_upper_layer":
		...
		return e.ResolveFileInUpperLayer(&e.Chown.FileEvent), nil
	...
	case "mkdir.in_upper_layer":
		...
		return e.ResolveFileInUpperLayer(&e.Mkdir.FileEvent), nil
	...
	case "open.in_upper_layer":
		...
		return e.ResolveFileInUpperLayer(&e.Open.FileEvent), nil
	...
	case "removexattr.in_upper_layer":
		...
		return e.ResolveFileInUpperLayer(&e.RemoveXAttr.FileEvent), nil
	...
	case "rmdir.in_upper_layer":
		...
		return e.ResolveFileInUpperLayer(&e.Rmdir.FileEvent), nil
	...
	case "setxattr.in_upper_layer":
		...
		return e.ResolveFileInUpperLayer(&e.SetXAttr.FileEvent), nil
	...
	case "unlink.in_upper_layer":
		...
		return e.ResolveFileInUpperLayer(&e.Unlink.FileEvent), nil
	...
	case "utimes.in_upper_layer":
		...
		return e.ResolveFileInUpperLayer(&e.Utimes.FileEvent), nil
...
func (e *Event) SetFieldValue(field eval.Field, value interface{}) error {
	...
	case "chmod.in_upper_layer":
		...
		var ok bool
		if e.Chmod.FileEvent.InUpperLayer, ok = value.(bool); !ok {
			return &eval.ErrValueTypeMismatch{Field: "Chmod.FileEvent.InUpperLayer"}
		}
		return nil
	...
	case "chown.in_upper_layer":
		...
		var ok bool
		if e.Chown.FileEvent.InUpperLayer, ok = value.(bool); !ok {
			return &eval.ErrValueTypeMismatch{Field: "Chown.FileEvent.InUpperLayer"}
		}
		return nil
	...
	case "mkdir.in_upper_layer":
		...
		var ok bool
		if e.Mkdir.FileEvent.InUpperLayer, ok = value.(bool); !ok {
			return &eval.ErrValueTypeMismatch{Field: "Mkdir.FileEvent.InUpperLayer"}
		}
		return nil
	...
	case "open.in_upper_layer":
		...
		var ok bool
		if e.Open.FileEvent.InUpperLayer, ok = value.(bool); !ok {
			return &eval.ErrValueTypeMismatch{Field: "Open.FileEvent.InUpperLayer"}
		}
		return nil
	...
	case "removexattr.in_upper_layer":
		...
		var ok bool
		if e.RemoveXAttr.FileEvent.InUpperLayer, ok = value.(bool); !ok {
			return &eval.ErrValueTypeMismatch{Field: "RemoveXAttr.FileEvent.InUpperLayer"}
		}
		return nil
	...
	case "rmdir.in_upper_layer":
		...
		var ok bool
		if e.Rmdir.FileEvent.InUpperLayer, ok = value.(bool); !ok {
			return &eval.ErrValueTypeMismatch{Field: "Rmdir.FileEvent.InUpperLayer"}
		}
		return nil
	...
	case "setxattr.in_upper_layer":
		...
		var ok bool
		if e.SetXAttr.FileEvent.InUpperLayer, ok = value.(bool); !ok {
			return &eval.ErrValueTypeMismatch{Field: "SetXAttr.FileEvent.InUpperLayer"}
		}
		return nil
	...
	case "unlink.in_upper_layer":
		...
		var ok bool
		if e.Unlink.FileEvent.InUpperLayer, ok = value.(bool); !ok {
			return &eval.ErrValueTypeMismatch{Field: "Unlink.FileEvent.InUpperLayer"}
		}
		return nil
	...
	case "utimes.in_upper_layer":
		...
		var ok bool
		if e.Utimes.FileEvent.InUpperLayer, ok = value.(bool); !ok {
			return &eval.ErrValueTypeMismatch{Field: "Utimes.FileEvent.InUpperLayer"}
		}
		return nil
